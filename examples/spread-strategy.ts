 ...
 *
 * A market making strategy that works across all supported exchanges.
 * Uses WebSocket for Polymarket/Limitless, REST polling for others.
 *
 * Usage:
 ...
 *   EXCHANGE=kalshi KALSHI_API_KEY_ID=... KALSHI_PRIVATE_KEY_PATH=... npx tsx examples/spread-strategy.ts
 *   EXCHANGE=opinion OPINION_API_KEY=... PRIVATE_KEY=0x... MULTI_SIG_ADDR=... npx tsx examples/spread-strategy.ts
